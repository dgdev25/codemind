 ...
 * @example
 * ```typescript
 * import { FileError, ParseError, setLogger, silentLogger } from 'codemind';;
 *
...
/**
 * Base error class for all CodeMind errors.
 *
 * All CodeMind-specific errors extend this class, allowing you to catch
 * all CodeMind errors with a single catch block.
 *
 * @example
 * ```typescript
 * try {
 *   await cg.indexAll();
 * } catch (error) {
 *   if (error instanceof CodeMindError) {
 *     console.log(`CodeMind error [${error.code}]: ${error.message}`);
 *   }
 * }
 * ```
 */
 ...
 */
export class FileError extends CodeMindError {
 ...
 */
export class ParseError extends CodeMindError {
  readonly filePath: string;
 ...
 */
export class DatabaseError extends CodeMindError {
 ...
 */
export class SearchError extends CodeMindError {
 ...
 */
export class VectorError extends CodeMindError {
  constructor(message: string, operation: string, cause?: Error) {
 ...
 */
export class ConfigError extends CodeMindError {
...
/**
 * Simple logger for CodeMind operations
 *
